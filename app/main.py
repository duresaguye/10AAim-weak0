...
plt.figure()
sns.histplot(df_benin['GHI'])
plt.title('Benin GHI Histogram')
plt.savefig('benin_ghi_histogram.png')

plt.figure()
sns.histplot(df_sierraleone['GHI'])
plt.title('Sierra Leone GHI Histogram')
plt.savefig('sierraleone_ghi_histogram.png')

plt.figure()
sns.histplot(df_togo['GHI'])
plt.title('Togo GHI Histogram')
plt.savefig('togo_ghi_histogram.png')